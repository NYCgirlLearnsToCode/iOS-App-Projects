//
//  PlaysProjectUnitTestingUITests.swift
//  PlaysProjectUnitTestingUITests
//
...
class PlaysProjectUnitTestingUITests: XCTestCase {
    ...
    func testUserFilteringByString() {
        ...
        XCTAssertEqual(app.tables.cells.count, 56, "there should be 7 words.")
    }
